...
<figure class="image">
  <img src="/uploads/Schermata%202021-03-09%20alle%2011.57.16.png" alt="prova">
  <figcaption>prova</figcaption>
</figure>
...
Oltre all'assorbimento dell'acqua da parte delle piante, anche le precipitazioni influenzano i valori della RAW, portando un'aumento del contenuto di acqua nel suolo. Inoltre Le precipitazioni che non contribuiscono alla riserva di umidità disponibile delle colture (precipitazioni "inefficaci") non dovrebbero essere considerate. Per esempio, la quantità di precipitazioni che viene persa a causa del deflusso superficiale o che tramite infiltrazione supera la zona delle radici deve essere ignorata.